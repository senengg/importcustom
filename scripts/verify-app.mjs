...
const formulaChecks = [
  ...
  "sortCommissionRowsAlphabetically(getDraftCommissionMaster())",
  "findDuplicateCommissionCategory(masterDraft.commissionMaster)",
  "getCanonicalCategoryFromRows(product.category, state.commissionMaster)",
  "Rename New Category before adding another category.",
